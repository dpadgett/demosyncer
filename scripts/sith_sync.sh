#!/bin/bash
HOST="185.16.85.137:21"
USER=${SITH_USER}
PASS=${SITH_PASS}
FTPURL="ftp://$USER:$PASS@$HOST"
LCD="/cygdrive/D/demos/sith"
...
ssh -A dan@dpadgett.org "lftp -c \"set ftp:timezone CET; set net:timeout 15; set net:max-retries 2; set net:reconnect-interval-base 5; open '$FTPURL'; lcd '$LCD'; cd '$CD' && mirror --verbose -P 8\"" \
