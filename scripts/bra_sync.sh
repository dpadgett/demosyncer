...
ssh -A dan@dpadgett.org "lftp -c \"set ftp:timezone UTC; set net:timeout 15; set net:max-retries 2; set net:reconnect-interval-base 5; open '$FTPURL'; lcd '$LCD'; cd '$CD' && mirror --verbose -P 8\"" \
